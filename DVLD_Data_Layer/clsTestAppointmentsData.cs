...
namespace DVLD_Data_Layer
{
    public class clsTestAppointmentsData
    {
        ...
        public static DataTable GetApplicationTestsAppointmentsPerTestType(int LocalDrivingLicenseApplicationID, int TestTypeID)
        {
            DataTable dt = new DataTable();
        ...
        public static int AddNewTaskAppointmet(int TestTypeID,int LocalDrivingLicenseApplicationID, DateTime AppointmentDate,
            float PaidFees, int CreatedByUserID, int RetakeTestApplicationID)
        {
            int TaskAppointmetID = -1;
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.connectionString);
            ...
            return TaskAppointmetID;
        }
        public static bool UpdateTaskAppointmet(int TestAppointmentID, int TestTypeID, int LocalDrivingLicenseApplicationID,
