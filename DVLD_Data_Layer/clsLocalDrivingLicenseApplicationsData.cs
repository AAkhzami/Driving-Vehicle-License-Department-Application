...
namespace DVLD_Data_Layer
{
    public class clsLocalDrivingLicenseApplicationsData
    {
        ...
        public static int AddNewLocalLicenseApplications(int ApplicationID, int LicenseClassID)
        {
            int PersonId = -1;
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.connectionString);
        ...
        public static bool UpdataeLocalDrivingLicenseApplication(int LocalDrivingLicenseApplicationID, int ApplicationID, int LicenseClassID)
        {
            int rowsAffected = 0;
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.connectionString);
